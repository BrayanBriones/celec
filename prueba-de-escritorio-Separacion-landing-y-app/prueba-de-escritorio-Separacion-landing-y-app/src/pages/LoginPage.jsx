  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Has iniciado sesión como ${user?.role ?? 'usuario'}.`,
      });
      const destination = user?.type ? `/dashboard/${user.type}` : '/';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Inicia sesión en tu cuenta de KIOSKU BITES para acceder a tus combos y reservas."
        />
      </Helmet>
      ...
      <div className="min-h-screen flex bg-gray-50">
        <div className="hidden lg:block relative w-0 flex-1 lg:w-1/2 xl:w-2/3">
          <img
            ...
            src="https://images.unsplash.com/photo-1656167718265-a05fe70cdf52"
          />
          <div className="absolute inset-0 bg-primary/70 flex flex-col items-center justify-center text-white p-12 text-center">
            ...
            >
              ...
              <p className="mt-4 text-xl opacity-90">
                Únete a miles de personas que ya disfrutan de comida deliciosa a precios increíbles.
              </p>
            </motion.div>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Button
                    ...
                    className="flex w-full justify-center btn-gradient py-3 text-lg"
                  >
